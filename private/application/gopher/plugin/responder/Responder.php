<?php
namespace application\gopher\plugin\responder
{
	use nutshell\behaviour\Singleton;
	use nutshell\core\plugin\Plugin;
	use nutshell\core\exception\NutshellException;
	use application\gopher\helper\MimeHelper;
	use application\gopher\plugin\responder\ResponderException;
...
// 			}
		...
		private function handler_geojson()
		{
			print json_encode($this->data);
		}
